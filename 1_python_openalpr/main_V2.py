        ...
        try:
            if presence[0] == True:
                ...
                try:
                    ...
                    print("Il y a un soucie avec la reponse de la bdd" +
                        " \n    - Verifier qu'une palque est bien presente.")
        except _resulte_capteur:
            print("Il y a un probleme avec la reponse du modbus")
