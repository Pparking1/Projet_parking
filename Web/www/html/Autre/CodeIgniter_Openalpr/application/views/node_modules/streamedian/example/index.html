...
<div>
    <span style="color:#808080">Change file length</span>
    <input id="file_length" type="range" min="10" max="200" style="width:40%;">
    <p id="file_length_label">180sec.</p>
</div>
...
<script>
    if (window.Streamedian) {
        ...
        let dataHandler = function(data) {
            let blob = new Blob([data.detail], {type: "application/mp4"});
        ...
        var fileLength  = document.getElementById("file_length");
        var fileLengthLabel  = document.getElementById("file_length_label");
        ...
        fileLength.addEventListener('input', function(event) {
            let seconds = parseInt(event.target.value, 10);
            let milliseconds = seconds * 1000;
            player.continuousFileLength = milliseconds;
            player.eventFileLength = milliseconds;
            fileLengthLabel.innerText = `${seconds} sec.`;
        });
        ...
        function setPlayerSource(newSource) {
            if (checkRecord.checked) {
                playerOptions.continuousFileLength = parseInt(fileLength.value, 10) * 1000;
            }
            ...
            player.continuousRecording(checkRecord.checked);
            updateRangeControls();
