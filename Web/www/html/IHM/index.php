...
?>
    ...
    if(!isset($_SESSION['prenom'])){
			...
			header('Location: ../PageLogin/index.php');
			exit;
	 ...
	 ?></h4>
	 <a href="../PageLogin/testedeconnexion.php"><button>Deconnexion</button></a>
...
echo "<tr></br>";
   ...
   echo "<td>".$row['date_arrivee_est_garer']."</td>";
echo "</tr>";
}
      ?><br><br>
...
echo "<tr>";
   ...
   echo "<th>Nombre de place actuelle</th>";
echo "</tr>";
echo "</thead>";
}
...
echo "<tr>";
   ...
   echo "<td id=\"nb_place_actuelle\">".$row['Nombre_de_place_actuelle']."</td>"; 
echo "</tr>";
}
?>
<script>
  ...
  function actualise_nb_place() {
    nb_place = getElementById("nb_place_actuelle");
    nb
  }
</script>
</table>
...
<table>
	<tr>
		<td>Ouvrir la barrière d'entree: </td>
		<td>
			<label class="switch">
	...
	<tr>
		<td>Ouvrir la barrière de sortie: </td>
		<td>
			<label class="switch">
